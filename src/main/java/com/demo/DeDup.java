...
public class DeDup {
    ...
    /**
     * Positive : Performance will be good with small size array 
     * Negative : for large size array directly effecting system performance because of internally position shifting as well as may not return expected result 
     * 
     * @param arr 
    ...
    /**
     * Positive : No much changes in internal structure of original array as well as maintaining original insertion order. 
     * Negative : Default initialization of result array with input array size and manipulation in size of result array 
     * 
     * @param arr
     * @return Array with Unique elements.
     */
	...
	public int[] removeArrayDuplicates(int[] inputArray) {
	 ...
	 /**
     * 
     * Positive : Highly efficient with large size of array as time complexity with Set is o(N)  
     * Negative : does not guarantee order of elements returned. 
     * 
     * @param arr 
     * @return Array with Unique elements.
     */
